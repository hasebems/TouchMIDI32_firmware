...
static void ClockSetup(void)
{
	...
	CY_SET_REG32(CYREG_CLK_PLL0_CONFIG, 0x8002050Cu);
	CyDelayCycles(240u);
	CY_SET_REG32(CYREG_CLK_PLL0_CONFIG, 0xC002050Cu);
	for (pllTimeout = 0u; (pllTimeout < 25u) && (CY_GET_REG32(CYREG_CLK_PLL0_STATUS) == 0u); pllTimeout++)
	{
		CyDelayCycles(480u);
	}

	/* Setup phase aligned clocks */
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL5, 0x0000BF00u);
	...
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_CLK_SELECT), 0x00080090u);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDB_INT_CLK_CTL, 0x01u);
	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x400F345Du, /* Base address: 0x400F3400 Count: 93 */
			0x400F354Eu, /* Base address: 0x400F3500 Count: 78 */
			0x400F364Fu, /* Base address: 0x400F3600 Count: 79 */
			0x400F3747u, /* Base address: 0x400F3700 Count: 71 */
			...
			0x400F470Du, /* Base address: 0x400F4700 Count: 13 */
		...
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_HSIOM_PORT_SEL5), 0x0000FFFFu);
		...
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_UDB_PA5_CFG8), 0x10000000u);

		/* UDB_PA_7 Starting address: CYDEV_UDB_PA7_BASE */
		CY_SET_XTND_REG32((void CYFAR *)(CYDEV_UDB_PA7_BASE), 0x00990004u);
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_UDB_PA7_CFG4), 0x00020000u);
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_UDB_PA7_CFG8), 0x00080000u);

		/* INT_SELECT Starting address: CYDEV_CPUSS_INT_SEL */
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_CPUSS_INT_SEL), 0x0000000Fu);

		/* INT_CONFIG Starting address: CYDEV_UDB_INT_CFG */
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_UDB_INT_CFG), 0x0000000Bu);
	...
	CY_SET_XTND_REG32((void CYFAR *)(CYDEV_GPIO_PRT0_BASE), 0x000000FEu);
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_GPIO_PRT0_PC2), 0x000000FFu);
	...
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_GPIO_PRT1_PC2), 0x000000FFu);

	/* IOPINS0_2 Starting address: CYDEV_GPIO_PRT2_BASE */
	CY_SET_XTND_REG32((void CYFAR *)(CYDEV_GPIO_PRT2_BASE), 0x000000FFu);
	...
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_GPIO_PRT3_PC), 0x00DB6D89u);
	...
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_GPIO_PRT4_PC2), 0x0000005Cu);

	/* IOPINS0_5 Starting address: CYDEV_GPIO_PRT5_BASE */
	CY_SET_XTND_REG32((void CYFAR *)(CYDEV_GPIO_PRT5_BASE), 0x0000000Du);
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_GPIO_PRT5_PC), 0x00030D8Eu);
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_GPIO_PRT5_PC2), 0x0000000Du);

	/* IOPINS0_6 Starting address: CYDEV_GPIO_PRT6_BASE */
	CY_SET_XTND_REG32((void CYFAR *)(CYDEV_GPIO_PRT6_BASE), 0x00000037u);
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_GPIO_PRT6_PC2), 0x00000037u);
