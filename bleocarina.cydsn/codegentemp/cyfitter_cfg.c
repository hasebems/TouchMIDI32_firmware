...
static void ClockSetup(void)
{
	...
	CY_SET_REG32((void *)CYREG_PERI_DIV_16_CTL4, 0x0000BF00u);
	...
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_PERI_PCLK_CTL19), 0x00000044u);
...
void cyfitter_cfg(void)
{
	...
	CY_SET_REG8((void *)CYREG_UDB_UDB_INT_CLK_CTL, 0x01u);
	{
		static const uint32 CYCODE cy_cfg_addr_table[] = {
			...
			0x400F354Bu, /* Base address: 0x400F3500 Count: 75 */
			0x400F3656u, /* Base address: 0x400F3600 Count: 86 */
			...
			0x400F4609u, /* Base address: 0x400F4600 Count: 9 */
			0x400F470Eu, /* Base address: 0x400F4700 Count: 14 */
		...
		CY_SET_XTND_REG32((void CYFAR *)(CYREG_UDB_PA5_CFG8), 0x20000000u);
	...
	CY_SET_XTND_REG32((void CYFAR *)(CYREG_GPIO_PRT5_PC), 0x00000249u);
